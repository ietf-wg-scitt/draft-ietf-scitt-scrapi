...
Milestone: Address Review from Mohamed Boucadair
Milestone URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/milestone/2?closed=1

Mailing list email: Mohamed Boucadair review on the SCITT mailing list
Mailing list URL: https://mailarchive.ietf.org/arch/msg/scitt/aynYWkU1mIR1CD8YF5YHXi7S7jI/

Issue #148: Clarify characterization of "normative requirements" of SCITT
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/148
...
Fix PR: #168 Clarify characterization of "normative requirements" of SCITT
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/168

PR #168 modified the Abstract and the Introduction by adding the "Scope and Relation to the SCITT Architecture" subsection.

Issue #149: NIST.SP.800-57pt1r5 reference: clarify mapping, consider making normative, and note operational implications
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/149
...
Fix PR: #167 Clarify NIST SP 800-57 reference, promote to normative, and document key-retention operational implications
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/167

PR #167 modified the references metadata and the Transparency Service Keys section's retired-key retention guidance.

Issue #150: MAY conflicts with MUST in error handling requirements
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/150
...
Fix PR: #166 Resolve MUST/MAY conflict in error handling requirements
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/166
...
Issue #151: RFC9921 reference should be normative
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/151
...
Fix PR: #169 Move RFC9921 to normative references and clarify timestamp mechanisms
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/169

PR #169 modified the references metadata and the Replay Attacks subsection of Security Considerations.

Issue #152: Move normative content from IANA Section 5.1.1 to the main body
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/152
...
Fix PR: #165 Move normative content from IANA §5.1.1 to main body
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/165
...
Issue #153: Expand SCITT acronym in the document title
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/153

Quote from Mohamed:

> Please expand SCITT in the title (Supply Chain Integrity, Transparency, and Trust).

Fix PR: #164 Expand SCITT acronym in document title
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/164

PR #164 modified the document front matter title.

Issue #154: Review normative language for compliance with BCP56 (RFC 9205 Section 4.6)
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/154
...
Fix PR: #163 Audit normative HTTP status code language for BCP 56 / RFC 9205 §4.6 compliance
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/163
...
Issue #155: Add Operational Considerations section for retry behavior and rate limiting
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/155
...
Fix PR: #162 Add Operational Considerations section for retry behavior and rate limiting
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/162
...
Issue #156: Add cross-references for conformance resources and deduplicate MUST requirements
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/156
...
Fix PR: #161 Add cross-references for conformance resources and deduplicate MUST
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/161

PR #161 modified the Introduction's conformance resource list and the Resources section preamble.

Issue #157: Add justification for COSE Key Thumbprint (RFC 9679) recommendation
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/157
...
Fix PR: #160 Add justification for COSE Key Thumbprint (RFC 9679) recommendation
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/160
...
Issue #158: Fix inappropriate normative language: "MAY fail" should be "may fail"
Issue URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/issues/158
...
Fix PR: #159 Fix inappropriate normative language: "MAY fail" → "may fail"
PR URL: https://github.com/ietf-wg-scitt/draft-ietf-scitt-scrapi/pull/159
